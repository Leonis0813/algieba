  ...
  context '異常系' do
    context 'create' do
      ...
      [
        ...
        context description do
          ...
          it_behaves_like '400エラーをチェックする', invalid_param.keys.map {|key| "invalid_value_#{key}" }
        end
      end
    end
    ...
    context 'read' do
      [
        ...
        context description do
          ...
          it_behaves_like '400エラーをチェックする', condition.keys.map {|key| "invalid_value_#{key}" }
        end
      end
    end
    ...
    context 'update' do
      [
        ...
        context description do
          ...
          it_behaves_like '400エラーをチェックする', (condition || with).keys.map {|key| "invalid_value_#{key}" }
        end
      end
      ...
      context '更新後の値がない場合' do
        ...
        it_behaves_like '400エラーをチェックする', ['invalid_value_with']
      end
    ...
    context 'delete' do
      [
        ...
        context description do
          ...
          it_behaves_like '400エラーをチェックする', invalid_condition.keys.map {|key| "invalid_value_#{key}" }
        end
      end
    end
    ...
    context 'settle' do
      context '不正な期間を指定する場合' do
        ...
        it_behaves_like '400エラーをチェックする', ['invalid_value_interval']
      end
