...
describe 'dictionaries/index', type: :view do
  ...
  shared_examples '登録フォームが表示されていること' do
    ...
    form_base_xpath = [
      create_form_xpath,
      'form[@id="form-dictionary-create"]',
    ...
    it '登録ボタンが表示されていること' do
      xpath = "#{create_form_xpath}/form[@id='form-dictionary-create']/" \
              'input[@value="登録"]'
  ...
  shared_examples '件数情報が表示されていること' do |total: 0, from: 0, to: 0|
    it do
      info = @html.xpath("#{dictionary_list_xpath}/div/span[@id='page-info']/h4")
  ...
  shared_examples 'ページングが表示されていること' do
    paging_xpath = "#{dictionary_list_xpath}/span[@id='paginate']" \
